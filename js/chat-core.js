window.ChatAPI = (function () {
  ...
  async function ask(message) {
    ...
    return {
      text: 'I could not find a confident answer offline, and the AI service is not connected on this deployment. Try asking about the formula, eligibility, the 50% wage rule, or the ₹20 lakh tax cap.',
      source: 'none'
    };
  }
